  ...
  <div class="wrapper">
    ...
    <form method="POST" action="update_acc.php?id=<?= $id; ?>">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="fname" name="fname" value="<?= $account['FirstName']; ?>" required>
            </div>
        </div>
        <div class="row mb-3">
            <label for="lname" class="col-sm-2 col-form-label">Last Name:</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="lname" name="lname" value="<?= $account['LastName']; ?>" required>
            </div>
        </div>
