...
if (isset($_POST['advancesearch'])) {
  ...
  if (!empty($work_status))
    $query .= " AND work_status = '$work_status'";
  if (!empty($educational_background))
    $query .= " AND educational_background = '$educational_background'";
  if (!empty($youth_classification))
    $query .= " AND youth_classification = '$youth_classification'";
  if (!empty($register_sk_voter))
    $query .= " AND register_sk_voter = '$register_sk_voter'";
                      ...
                      <?php echo htmlspecialchars($age_max); ?>">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <select class="form-control" id="youth_classification" name="youth_classification">
                                      ...
                                      <option value="Person With Disability (PWD)" <?php echo $youth_classification == 'Person With Disability (PWD)' ? 'selected' : ''; ?>>
                          ...
                          <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" name="clearfilterarchive">Clear
                              Filter</button>
                          </div>
                          </form>
                        </div>
