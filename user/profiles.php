         ...
         <div class="card-header">
          <div class="ms-auto">
           <button id="newProfile" style="float: left" class="btn btn-primary btn-round ms-auto" data-bs-toggle="modal" data-bs-target="#addRowModal">
            ...
            <button id="exportBtn" class="btn btn-primary btn-round ms-auto"><i class="fa fa-download"></i>Export</button>
           ...
           <button type="button" style="float: right;" class="btn btn-primary btn-round ms-auto" data-bs-toggle="modal" data-bs-target="#advanceSearchModal">
            <i class="fa fa-search"></i> Advance Search </button>
           <div class="modal fade" id="advanceSearchModal" tabindex="-1" role="dialog" aria-labelledby="advanceSearchModalTitle" aria-hidden="true">
            <div class="modal-dialog" role="document">
             <div class="modal-content">
              <div class="modal-header">
               <h5 class="modal-title fw-bold" id="advanceSearchModalTitle">Advance Search</h5>
                ...
                <form method="POST">
                 <div class="row">
                  ...
                  <div class="col-md-6">
                   ...
                   <div class="form-group form-group-default">
                    <input type="text" class="form-control" placeholder="Purok" name="purok" />
                   </div>
                  </div>
                  <div class="col-sm-12">
                   <div class="form-group form-group-default">
                    <input type="text" class="form-control" placeholder="House Number" name="house_number" required/>
                   </div>
                  </div>
                  <div class="col-md-6">
                   <div class="form-group form-group-default">
                    ...
                    <div>
                    <select style="width: 68%" id="birth_month" name="birth_month" required onchange="calculateAge()">
                    ...
                    <select style="width: 30%" id="birth_day" name="birth_day" required onchange="calculateAge()">
                      <option value="">Day</option>
                      <?php for ($d = 1; $d <= 31; ++$d): ?>
                        <option value="<?php echo $d; ?>"><?php echo $d; ?></option>
                      <?php endfor; ?>
                    </select>
                    <input style="width: 100%" type="number" id="birth_year" name="birth_year" placeholder="Year" required oninput="calculateAge()">
                  </div>
                  ...
                  <div class="col-md-6">
                   <div class="form-group form-group-default">
                    ...
                    <input type="radio" name="youth_classification" value="Person With Disability" required> Person With Disability<br>
                   </div>
                  </div>
                  <div class="col-md-6">
                   <div class="form-group form-group-default">
